...
const { signupAgent, logIn, verify, logOut, deleteProfileImg, getAllFollowers, getOneFollower, getAllUsers, createProfileImg, changePassword, updateUserName, getUsers, deleteAccount, updateUserProfile, resendOTP, follow, unfollow,
    isAdmin, resetPassword, verifyPasswordOTP, updateEmail, forgotPassword, signupPlayer, home, subscription, getSubscription, getAllFollowing, getOneFollowing } = require("../controllers/userController")
...
router.get('/following/one', authenticate, getOneFollowing)
